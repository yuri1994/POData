...
namespace FirebirdOData\PODataLaravel\Query;

use FirebirdOData\PODataLaravel\Auth\NullAuthProvider;
...
use FirebirdOData\PODataLaravel\Providers\MetadataProvider;
