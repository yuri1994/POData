...
class TCollectionTypeType extends IsOK
{
    ...
    /**
     * @property \Firebird\ODataMetadata\MetadataV3\edm\TTypeRefType $typeRef
     */
    ...
    {
        if (!$this->isValidArray($rowType, '\Firebird\ODataMetadata\MetadataV3\edm\TPropertyType', $msg)) {
            throw new \InvalidArgumentException($msg);
        }
     ...
     * Gets as typeRef.
     *
     * @return \Firebird\ODataMetadata\MetadataV3\edm\TTypeRefType
     */
     ...
     * Sets a new typeRef.
     *
     * @param  \Firebird\ODataMetadata\MetadataV3\edm\TTypeRefType $typeRef
     * @return self
     */
    ...
    public function isOK(&$msg = null)
    {
        ...
        if (!$this->isValidArray($this->rowType, '\Firebird\ODataMetadata\MetadataV3\edm\TPropertyType', $msg)) {
            return false;
        }
