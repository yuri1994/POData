...
class TComplexTypeType extends IsOK
{
    ...
    /**
     * @property \Firebird\ODataMetadata\MetadataV3\edm\TComplexTypePropertyType[] $property
     */
    private $property = [];
     ...
     * Adds as property.
     *
     * @param  \Firebird\ODataMetadata\MetadataV3\edm\TComplexTypePropertyType $property
     * @return self
     */
     ...
     * Gets as property.
     *
     * @return \Firebird\ODataMetadata\MetadataV3\edm\TComplexTypePropertyType[]
     */
    ...
    public function setProperty(array $property)
    {
        if (!$this->isValidArrayOK(
            $property,
            '\Firebird\ODataMetadata\MetadataV3\edm\TComplexTypePropertyType',
            $msg
        )
        ) {
            throw new \InvalidArgumentException($msg);
